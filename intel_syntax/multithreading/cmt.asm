...
0000000000001070 <clone@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmp *0x2f55(%rip)        # 3fd0 <clone@GLIBC_2.2.5>
...
0000000000001120 <__do_global_dtors_aux>:
    ...
    1124:	80 3d f5 2e 00 00 00 	cmpb   $0x0,0x2ef5(%rip)        # 4020 <completed.0>
    ...
    114c:	c6 05 cd 2e 00 00 01 	movb   $0x1,0x2ecd(%rip)        # 4020 <completed.0>
    1153:	5d                   	pop    %rbp
    1154:	c3                   	ret    
...
0000000000001169 <_Z7thread2Pv>:
    ...
    1183:	e8 d8 fe ff ff       	call   1060 <puts@plt>
...
000000000000118f <main>:
    ...
    1197:	48 8d 05 78 0e 00 00 	lea    0xe78(%rip),%rax        # 2016 <_IO_stdin_used+0x16>
    119e:	48 89 c7             	mov    %rax,%rdi
    11a1:	e8 ba fe ff ff       	call   1060 <puts@plt>
    11a6:	48 8d 05 93 3e 00 00 	lea    0x3e93(%rip),%rax        # 5040 <_end>
    11ad:	41 b9 00 00 00 00    	mov    $0x0,%r9d
    11b3:	41 b8 00 00 00 00    	mov    $0x0,%r8d
    11b9:	b9 00 00 00 00       	mov    $0x0,%ecx
    11be:	ba 00 00 00 00       	mov    $0x0,%edx
    11c3:	48 89 c6             	mov    %rax,%rsi
    11c6:	48 8d 05 9c ff ff ff 	lea    -0x64(%rip),%rax        # 1169 <_Z7thread2Pv>
    11cd:	48 89 c7             	mov    %rax,%rdi
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	e8 96 fe ff ff       	call   1070 <clone@plt>
